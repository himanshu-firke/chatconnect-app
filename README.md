...
## 🚀 NEW: UI & 5x Performance Boost!
ChatConnect has been enhanced with a **modern design** and **major performance optimizations**. See [`ENHANCEMENTS.md`](./ENHANCEMENTS.md) for details.
